...
<div class="left-menu bg-white border-right" id="sidebar-wrapper">
    ...
    <div class="sidebar-heading mt-5"><img src="imgs/logoww.svg"></div>
    <div class="list-group list-group-flush mt-5">
        ...
        <a href="{{route('labs.logout')}}" class="list-group-item list-group-item-action mb-5 h5"><i class="fas fa-sign-out-alt mr-2"></i> Logout</a>
