...
@section('title','Edit profile labs')
@section('content')
<!-- edit profile labs -->
<!-- Sidenav -->
                        ...
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <div class="media align-items-center">
                            <span class="avatar avatar-sm rounded-circle"> 
                              <img alt="Image placeholder" src="{{url('uploads/labs/' . $labs->image)}}">
                            </span>
                            <div class="media-body ml-3 mr-3 d-lg-block">
                              <h6 class="mb-0 font-weight-bold text-white">{{$labs->firstName . ' ' . $labs->middleName}}</h6>
                            </div>
                          </div>
                        </a>
                      </li>
                ...
                <div class="col-xl-4 order-xl-2">
                  <div class="card card-profile">
                    ...
                    <div class="row justify-content-center">
                      <div class="col-lg-3 order-lg-2">
                        <div class="card-profile-image">
                          <a href="#">
                            <img src="{{url('uploads/labs/' . $labs->image)}}" class="rounded-circle">
                          </a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="col">
                          <div class="card-profile-stats d-flex justify-content-center">
                            <div class="text-center mt-3">
                              <span class="heading h5">22</span>
                              <h2 class="h5 text-gray">{{$labs->labsName}}</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="">
                        <h5 class="h5 mt-3"><i class="fas fa-hospital-alt mr-3 text-primary"></i>{{$labs->Primary_Speciality}}</h5>
                        <h5 class="h5 mt-3"><i class="fas fa-location-arrow mr-3 text-primary"></i>{{$labs->country}}</h5>
                        <h5 class="h5 mt-3"><i class="fas fa-notes-medical mr-3 text-primary"></i>{{$labs->telephone}}</h5>
                        <h5 class="h5 mt-3"><i class="fas fa-mail-bulk mr-3 text-primary"></i>{{$labs->email}}</h5>
                        <h5 class="h5 mt-3 "><i class="fa fa-phone mr-3 text-primary" aria-hidden="true"></i> {{$labs->phoneNumber}}</h5>
                ...
                <div class="col-xl-8 order-xl-1">
                  <div class="card pr-5 pl-5">
                    ...
                    <div class="card-body">
                      ...
                      <form action="{{route('labs.update.profile',$labs->id)}}" id = "edit-labs" data-id = "{{$labs->id}}" enctype="multipart/form-data" role="form" action="" class="login-box" method="POST">
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name = "old_password" value="{{$labs->password}}">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">labs Name</label>
                                    <input value = "{{$labs->labsName}}" class="form-control" type="text" name="labsName" placeholder="labs Name">
                                </div>
                            </div>
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Medical License Namber</label>
                                    <input value = "{{$labs->Medical_License_Number}}" class="form-control" type="text" placeholder="Medical License Namber" name="Medical_License_Number">
                                </div>
                            </div>
                            {{-- <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Hospital License</label>
                                    <input class="form-control" type="file" placeholder="Hospital License" name="labs_License">
                                </div>
                            </div> --}}
                            <div class="col-md-4 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Phone Number</label>
                                    <input value = "{{$labs->phoneNumber}}" class="form-control" type="text" name="phoneNumber" placeholder="Phone Number">
                                </div>
                            </div>
                            <div class="col-md-4 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Telephone</label>
                                    <input value = "{{$labs->telephone}}" class="form-control" type="text" name="telephone" placeholder="Telephone">
                                </div>
                            </div>
                            <div class="col-md-4 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Hotline</label>
                                    <input value = "{{$labs->Hotline}}" class="form-control" type="text" name="Hotline" placeholder="Hotline">
                                </div>
                            </div>
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Country</label>
                                    <input value = "{{$labs->country}}" class="form-control" type="text" name="country" placeholder="Country">
                                </div>
                            </div>
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">ZIP Code</label>
                                    <input value = "{{$labs->zip_code}}" class="form-control" type="text" name="zip_code" placeholder="ZIP Code">
                                </div>
                            </div>
                            <div class="col-md-12 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Email</label>
                                    <input value = "{{$labs->email}}" class="form-control" type="email" name="email" placeholder="Email">
                                </div>
                            </div>
                            {{-- <div class="col-md-12 mb-xl-3">
                                <div class="form-group">
...
@section('scripts')
    {{-- <script>
        $(function(){
            $('#edit-labs').on('submit',function(e){
                e.preventDefault();
                var formData = new FormData($("#edit-labs")[0]),
                    path = "{{route('labs.update.profile',':id')}}",
                    labsID = $(this).attr('data-id'),
                    path = path.replace(':id',labsID);
                    $.ajax({
                        url:path,
                        method:'put',
