                        ...
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <div class="media align-items-center">
                            ...
                            <div class="media-body ml-3 mr-3 d-lg-block">
                              <h6 class="mb-0 font-weight-bold text-white">{{$xray->firstName . ' ' . $xray->middleName}}</h6>
                            </div>
                          </div>
                        </a>
                      </li>
                ...
                <div class="col-xl-4 order-xl-2">
                  <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="col">
                          <div class="card-profile-stats d-flex justify-content-center">
                            <div class="text-center mt-3">
                              ...
                              <h2 class="h5 text-gray">{{$xray->xrayName}}</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="">
                        <h5 class="h5 mt-3"><i class="fas fa-hospital-alt mr-3 text-primary"></i>{{$xray->Primary_Speciality}}</h5>
                        <h5 class="h5 mt-3"><i class="fas fa-location-arrow mr-3 text-primary"></i>{{$xray->country}}</h5>
                        <h5 class="h5 mt-3"><i class="fas fa-notes-medical mr-3 text-primary"></i>{{$xray->telephone}}</h5>
                        <h5 class="h5 mt-3"><i class="fas fa-mail-bulk mr-3 text-primary"></i>{{$xray->email}}</h5>
                        <h5 class="h5 mt-3 "><i class="fa fa-phone mr-3 text-primary" aria-hidden="true"></i> {{$xray->phoneNumber}}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5">Xray Name</label>
