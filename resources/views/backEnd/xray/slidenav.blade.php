...
<div class="left-menu bg-white border-right" id="sidebar-wrapper">
    ...
    <div class="sidebar-heading mt-5"><img src="{{url('imgs/logo4.png')}}" width="120"></div>
    <div class="list-group list-group-flush mt-5">
        <a href="{{route('xray.profile',$xray->id)}}" class="list-group-item list-group-item-action h5"><i class="fa fa-home mr-2" aria-hidden="true"></i> Home</a>
        <a href="{{route('xray.edit.profile',$xray->id)}}" class="list-group-item list-group-item-action h5"><i class="fas fa-user-edit mr-2"></i> Edit Profile</a>
        <div class="dropdown">
        ...
        <a href="{{route('xray.logout')}}" class="list-group-item list-group-item-action mb-5 h5"><i class="fas fa-sign-out-alt mr-2"></i> Logout</a>
