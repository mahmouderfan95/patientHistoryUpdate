            ...
            <div class="col-md-10">
                ...
                <form role="form" enctype="multipart/form-data" action="{{route('xray_post_Register')}}"  method="POST" class="login-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h3 font-weight-bold">X-ray License</label>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="tel" name="phoneNumber" placeholder="Phone Number" style="padding-left: 70px">
                                 <select style="position: relative;bottom: 34px;width: 25%;" name="countryCode" id="" class="form-control">
