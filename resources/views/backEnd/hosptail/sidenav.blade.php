...
<div class="left-menu bg-white border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush mt-5">
        <a href="{{route('hosptail.profile',$hosptail->id)}}" class="list-group-item list-group-item-action h5"><i class="fa fa-home mr-2" aria-hidden="true"></i> Home</a>
        <a href="{{route('hosptail.edit.profile',$hosptail->id)}}" class="list-group-item list-group-item-action h5"><i class="fas fa-user-edit mr-2"></i> Edit Profile</a>
        <div class="dropdown">
