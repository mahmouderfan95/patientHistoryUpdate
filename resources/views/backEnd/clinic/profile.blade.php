                  ...
                  <div class="col-xl-12 col-md-12 pt-2 pr-4 pl-4 pb-5 mr-auto ml-auto">
                    <div class="card card-stats">
                      ...
                      <div class="card-body">
                        ...
                        @endforeach
                        <h5 class=" font-weight-bold p-4">Enter your ID</h5>
                        <form action="{{route('clinic.patient.search',$clinic->id)}}" method="GET">
                        <div class="row m-1">
                            <div class="col-md-8 mr-auto ml-auto ui input large mb-3">
                                <input class="form-control" type="text" name="search" placeholder="ID" required = "required">
                            </div>
                                ...
                                <table class="table table-striped">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><img src="{{url(public_path('uploads/doctor/clinic/' . $doctor->image))}}"></td>
                                      <td>{{$doctor->name}}</td>
