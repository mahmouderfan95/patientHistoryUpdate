            ...
            <div class="container-fluid">
              <div class="header-body">
                <div class="col-md-10 slide-img">
                  <img class="d-xs-none" id="about-img" src="imgs/s1.jpg" height="300" width="895" alt="Responsive image">
                </div>
                <div class="row mt-3">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row m-1">
                            <div class="col-md-8 mr-auto ml-auto ui input large mb-3">
                                <input class="form-control" type="text" name="search" placeholder="Phone Number" required = "required">
                            </div>
