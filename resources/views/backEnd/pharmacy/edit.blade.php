                      ...
                      <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media align-items-center">
                          ...
                          <div class="media-body ml-3 d-none d-lg-block">
                            <h3 class="mb-0 font-weight-bold">{{$pharmacy->pharmacyName}}</h3>
                          </div>
                        </div>
                      </a>
                    </li>
                ...
                <div class="col-xl-4 order-xl-2">
                  <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                      ...
                      <div class="">
                        <h5 class="h3 mt-3"><i class="fas fa-hospital-alt mr-3 text-primary"></i>{{$pharmacy->Primary_Speciality}}</h5>
                        <h5 class="h3 mt-3"><i class="fas fa-location-arrow mr-3 text-primary"></i>{{$pharmacy->country}}</h5>
                        <h5 class="h3 mt-3"><i class="fas fa-notes-medical mr-3 text-primary"></i>{{$pharmacy->telephone}}</h5>
                        <h5 class="h3 mt-3"><i class="fas fa-mail-bulk mr-3 text-primary"></i>{{$pharmacy->email}}</h5>
                        <h5 class="h3 mt-3 "><i class="fa fa-phone mr-3 text-primary" aria-hidden="true"></i> {{$pharmacy->phoneNumber}}</h5>
