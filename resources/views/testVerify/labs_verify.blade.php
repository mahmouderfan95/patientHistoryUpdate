            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="reca-div">
                        ...
                        <div id="mobile-number">{{$labs['phoneNumber']}}</div>
                        <div id="recaptcha-container"></div>
                    </div>
                    <p class="alert alert-danger danger-Reg" style="display: none"></p>
                    <p style="display:none" class="alert alert-success suc-Reg">Success Reigster <a href="{{route('labs_verifcationCode',$labs['id'])}}">Please Login your Activate .. </a></p>
                ...
                <div class="col-6">
                    <div class="verfy-email">
                        ...
                        @endif
                        <a class = "btn btn-primary" href="{{route('labs_send_email',$labs['id'])}}">Verify Email</a>
                        {{-- <div>
