            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="reca-div">
                        ...
                        <div id="mobile-number">{{$clinic['phoneNumber']}}</div>
                        <div id="recaptcha-container"></div>
                    </div>
                    <p class="alert alert-danger danger-Reg" style="display: none"></p>
                    <p style="display:none" class="alert alert-success suc-Reg">Success Reigster <a href="{{route('clinic_verifcationCode',$clinic['id'])}}">Please Login your Activate .. </a></p>
                ...
                <div class="col-6">
                    <div class="verfy-email">
                        ...
                        @endif
                        <a class = "btn btn-primary" href="{{route('clinic_send_email',$clinic['id'])}}">Verify Email</a>
                        {{-- <div>
